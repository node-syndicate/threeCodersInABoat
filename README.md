...
# да питаме Дончо
  1. Са ли тези класове в дейта заради екстендабилити? полувъпрос
  2. Е ли data --> db access layer / buissnes logic layer 
  3. Защо подаваме два пъти като аргумент един и същи параметър / е ли заради статичните методи / ?
  4. Как да се справяме с грешките хвърлени в базата? Да ги пропагандираме ли?
